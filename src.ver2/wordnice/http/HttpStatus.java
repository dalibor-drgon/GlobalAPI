...
public class HttpStatus {
	...
	protected static TIntObjectMap<String> map;
	
	static {
		map = new TIntObjectHashMap<String>();
	...
	public static int matchStatusMessage(final String message) {
		final Value<Integer> ret = new Value<Integer>(-1);
		map.forEachEntry(new TIntObjectProcedure<String>() {

			@Override
			public boolean execute(int code, String msg) {
	...
	public static void main(String...strings) {
		System.out.println(matchStatusMessage("Not Found"));
	}
}
